...
int sd_epoll_opt_mod(struct sd_epoll_mgr *mgr, struct sd_epoll_opt *p_so); //修改
int sd_epoll_opt_del(struct sd_epoll_mgr *mgr, struct sd_epoll_opt *p_so); //从mgr中删除p_so
